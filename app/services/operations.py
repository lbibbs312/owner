...
def build_exception_items(anchor=None, dock_delay_minutes=30):
    ...
    for followup in open_followups:
        items.append({"severity": "medium", "category": followup.kind.replace("_", " ").title(), "label": followup.plant_name or "Operations follow-up", "detail": followup.details, "target_type": "followup", "target_id": followup.id})
